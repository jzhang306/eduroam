            ...
            if self.graphics == 'tkinter':                                                                                                                              
                ...
                if self.graphics == 'zenity':                                                                                                                           
                    command = ['zenity', '--forms', '--width=500',                                                                                                      
                               "--title={Config.title}".format(Config.title),                                                                                                               
                               "--text={Messages.credentials_prompt}".format(Messages.credentials_prompt),                                                                                                 
                               "--add-entry={Messages.username_prompt}".format(Messages.username_prompt),                                                                                               
                               "--add-password={Messages.enter_password}".format(Messages.enter_password),                                                                                             
                               "--add-password={Messages.repeat_password}".format(Messages.repeat_password),                                                                                            
                               "--separator", output_fields_separator]                                                                                                  
                elif self.graphics == 'yad':                                                                                                                            
                    command = ['yad', '--form',                                                                                                                         
                               "--title={Config.title}".format(Config.title),                                                                                                               
                               "--text={Messages.credentials_prompt}".format(Messages.credentials_prompt),                                                                                                 
                               "--field={Messages.username_prompt}".format(Messages.username_prompt), self.username,                                                                                    
                               "--field={Messages.enter_password}:H".format(Messages.enter_password),                                                                                                  
                               "--field={Messages.repeat_password}:H".format(Messages.repeat_password),                                                                                                 
                               "--separator", output_fields_separator]                                                                                                  
...
class WpaConf:                                                                                                                                                          
    ...
    def __prepare_network_block(ssid: str, user_data: Type[InstallerData]) -> str:                                                                                      
        ...
        if Config.eap_outer in ('PEAP', 'TTLS'):                                                                                                                        
            interface += "phase2=\".format()auth={Config.eap_inner}\"\n" \                                                                                                      
                         "\tpassword=\".format(){user_data.password}\"\n"                                                                                                       
            if Config.anonymous_identity != '':                                                                                                                         
                interface += "\tanonymous_identity=\".format(){Config.anonymous_identity}\"\n"                                                                                  
                                                                                                                                                                        
        elif Config.eap_outer == 'TLS':                                                                                                                                 
            interface += "\tprivate_key_passwd=\".format(){user_data.password}\"\n" \                                                                                           
                         "\tprivate_key=\".format(){os.environ.get('HOME')}/.cat_installer/user.p12"                                                                            
...
Config.url = " \                                                                                                                                                        
    ""http://www.tik.uni-stuttgart.de/beratung/hilfe/wlan/index.html"                                                                                                   
