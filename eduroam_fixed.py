...
parser.add_argument("--wpa_con", action='store_true', dest='wpa_conf',                                                                                                 
            ...
            if self.graphics == 'tkinter':                                                                                                                              
                ...
                if self.graphics == 'zenity':                                                                                                                           
                    command = ['zenity', '--forms', '--width=500',                                                                                                      
                               ...
                               r--text={Messages.credentials_prompt},                                                                                                 
                               r--add-entry={Messages.username_prompt},                                                                                               
                               r--add-password={Messages.enter_password},                                                                                             
                               r--add-password={Messages.repeat_password},                                                                                            
                               "--separator", output_fields_separator]                                                                                                  
                elif self.graphics == 'yad':                                                                                                                            
                    command = ['yad', '--form',                                                                                                                         
                               r--title={Config.title},                                                                                                               
                               r--text={Messages.credentials_prompt},                                                                                                 
                               r--field={Messages.username_prompt}, self.username,                                                                                    
                               r--field={Messages.enter_password}:H,                                                                                                  
                               r--field={Messages.repeat_password}:H,                                                                                                 
                               "--separator", output_fields_separator]                                                                                                  
        ...
        if NEW_CRYPTO_AVAILABLE:                                                                                                                                        
            ...
            try:                                                                                                                                                        
                ...
                if Config.use_other_tls_id:                                                                                                                             
                    return True                                                                                                                                         
                try:                                                                                                                                                    
                    self.username = p12[1].subject.get_attributes_for_oid(NameOID.COMMON_NAME)[0].value                                                                                            
                except crypto.Error:                                                                                                                                    
                    self.username = p12[1].subject.get_attributes_for_oid(NameOID.EMAIL_ADDRESS)[0].value                                                                                          
                return True                                                                                                                                             
...
class WpaConf:                                                                                                                                                          
    ...
    def __prepare_network_block(ssid: str, user_data: Type[InstallerData]) -> str:                                                                                      
        ...
        if Config.eap_outer in ('PEAP', 'TTLS'):                                                                                                                        
            interface += "phase2=\"auth={Config.eap_inner}\"\n" "\tpassword=\"{user_data.password}\"\n"                                                                                                       
            if Config.anonymous_identity != '':                                                                                                                         
                interface += "\tanonymous_identity=\"{Config.anonymous_identity}\"\n"                                                                                  
                                                                                                                                                                        
        elif Config.eap_outer == 'TLS':                                                                                                                                 
            interface += "\tprivate_key_passwd=\"{user_data.password}\"\n" "\tprivate_key=\"{os.environ.get('HOME')}/.cat_installer/user.p12"                                                                            
...
Messages.save_wpa_conf = "DBus module not found - please install " "dbus-python! NetworkManager configuration failed, but we may generate " "a wpa_supplicant configuration file if you wish. Be warned that your " "connection password will be saved in this file as clear text."                                                                                                     
...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " "be overwritten"                                                                                                                                                    
Config.instname = "University of Stuttgart"                                                                                                                             
Config.profilename = "STUDENT"                                                                                                                                          
Config.url = " ""http://www.tik.uni-stuttgart.de/beratung/hilfe/wlan/index.html"                                                                                                   
Config.email = "support@tik.uni-stuttgart.de"                                                                                                                           
Config.title = "eduroam CAT"                                                                                                                                            
Config.server_match = "eduroam.uni-stuttgart.de"                                                                                                                        
...
Config.user_realm = "stud.uni-stuttgart.de"                                                                                                                             
Config.ssids = ['eduroam']                                                                                                                                              
Config.del_ssids = []                                                                                                                                                   
Config.servers = ['DNS:eduroam.uni-stuttgart.de']                                                                                                                       
Config.use_other_tls_id = False                                                                                                                                         
Config.anonymous_identity = "wifi@stud.uni-stuttgart.de"                                                                                                                
